...
**Orchestration mode:** Audit observability coverage sequentially across metrics, logging, tracing, profiling, and RUM, then merge the coverage findings.
...
- **Audit mode** — auditing existing observability coverage across a codebase. Check metrics, logging, tracing, profiling, and RUM sequentially.
