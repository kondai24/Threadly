...
metadata:
  ...
  openclaw:
    ...
    install:
      - kind: go
        package: github.com/cweill/gotests/...@v1.9.0
        bins: [gotests]
    skill-library-version: "1.11.1"
allowed-tools: Read Edit Write Glob Grep Bash(go:*) Bash(golangci-lint:*) Bash(gotests:*) AskUserQuestion Bash(godig:*) Bash(gopls:*) LSP mcp__gopls__*
---
