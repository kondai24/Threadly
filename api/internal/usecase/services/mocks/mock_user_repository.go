...
//
//	mockgen -source=./internal/domain/repositories/user.go -destination=./internal/usecase/services/mocks/mock_user_repository.go -package=mocks
//
...
func (m *MockUserRepository) FindByID(ctx context.Context, id models.UUID) (*models.User, error) {
	m.ctrl.T.Helper()
